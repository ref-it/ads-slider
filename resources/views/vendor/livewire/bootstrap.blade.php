            ...
            <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
                <div>
                    <p class="small text-muted">
                        {!! __('Showing :start to :end of :results', [
                        'start' => "<span class='fw-semibold'>{$paginator->firstItem()}</span>",
                        'end' => "<span class='fw-semibold'>{$paginator->lastItem()}</span>",
                        'results' => "<span class='fw-semibold'>{$paginator->total()}</span>",
                    ]) !!}
                    </p>
                </div>
